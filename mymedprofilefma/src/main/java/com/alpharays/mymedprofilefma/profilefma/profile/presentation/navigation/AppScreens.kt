...
import com.alpharays.mymedprofilefma.profilefma.profile.profile_utils.util.ProfileConstants.APPOINTMENT_COMPLETE_SCREEN_ROUTE
import com.alpharays.mymedprofilefma.profilefma.profile.profile_utils.util.ProfileConstants.APPOINTMENT_START_SCREEN_ROUTE
import com.alpharays.mymedprofilefma.profilefma.profile.profile_utils.util.ProfileConstants.AUTH_SCREEN_ROUTE
import com.alpharays.mymedprofilefma.profilefma.profile.profile_utils.util.ProfileConstants.HOME_SCREEN_ROUTE
import com.alpharays.mymedprofilefma.profilefma.profile.profile_utils.util.ProfileConstants.PATIENT_SCREEN_ROUTE
